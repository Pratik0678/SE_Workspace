...
int main()
{
    ...
    if(per>=70 && maths>=35 && hin>=35 && guj>=35 &&eng>=35)
    {
        printf("\n A Grade");
    }
    else if(per>=60&& maths>=35 && hin>=35 && guj>=35 &&eng>=35)
    {
        printf("\n B Grade");
    }
    else if(per>=50 && maths>=35 && hin>=35 && guj>=35 &&eng>=35)
    {
        printf("\n C Grade");
    }
    else if(per>=40&& maths>=35 && hin>=35 && guj>=35 &&eng>=35)
    {
        printf("\n D Grade");
    }
    else
